...
, oci_artifacts_generic_artifacts = ./oci_artifacts_generic_artifacts.dhall
, oci_artifacts_repositories = ./oci_artifacts_repositories.dhall
...
, oci_bastion_bastions = ./oci_bastion_bastions.dhall
, oci_bastion_session = ./oci_bastion_session.dhall
, oci_bastion_sessions = ./oci_bastion_sessions.dhall
...
, oci_cloud_guard_data_mask_rules = ./oci_cloud_guard_data_mask_rules.dhall
...
, oci_containerengine_cluster_option =
    ./oci_containerengine_cluster_option.dhall
, oci_containerengine_clusters = ./oci_containerengine_clusters.dhall
, oci_containerengine_node_pool = ./oci_containerengine_node_pool.dhall
, oci_containerengine_node_pool_option =
    ./oci_containerengine_node_pool_option.dhall
, oci_containerengine_node_pools = ./oci_containerengine_node_pools.dhall
, oci_containerengine_work_request_errors =
    ./oci_containerengine_work_request_errors.dhall
, oci_containerengine_work_request_log_entries =
    ./oci_containerengine_work_request_log_entries.dhall
, oci_containerengine_work_requests = ./oci_containerengine_work_requests.dhall
, oci_core_app_catalog_listing = ./oci_core_app_catalog_listing.dhall
, oci_core_app_catalog_listing_resource_version =
    ./oci_core_app_catalog_listing_resource_version.dhall
, oci_core_app_catalog_listing_resource_versions =
    ./oci_core_app_catalog_listing_resource_versions.dhall
...
, oci_core_cpe_device_shapes = ./oci_core_cpe_device_shapes.dhall
...
, oci_core_cross_connect_groups = ./oci_core_cross_connect_groups.dhall
, oci_core_cross_connect_locations = ./oci_core_cross_connect_locations.dhall
...
, oci_core_instance_console_connections =
    ./oci_core_instance_console_connections.dhall
, oci_core_instance_credentials = ./oci_core_instance_credentials.dhall
, oci_core_instance_devices = ./oci_core_instance_devices.dhall
...
, oci_core_ipsec_config = ./oci_core_ipsec_config.dhall
, oci_core_ipsec_connections = ./oci_core_ipsec_connections.dhall
...
, oci_core_listing_resource_versions =
    ./oci_core_listing_resource_versions.dhall
...
, oci_core_route_tables = ./oci_core_route_tables.dhall
, oci_core_security_lists = ./oci_core_security_lists.dhall
, oci_core_service_gateways = ./oci_core_service_gateways.dhall
, oci_core_services = ./oci_core_services.dhall
, oci_core_shape = ./oci_core_shape.dhall
, oci_core_shapes = ./oci_core_shapes.dhall
...
, oci_core_volume_backup_policies = ./oci_core_volume_backup_policies.dhall
, oci_core_volume_backup_policy_assignments =
    ./oci_core_volume_backup_policy_assignments.dhall
, oci_core_volume_backups = ./oci_core_volume_backups.dhall
...
, oci_database_data_guard_associations =
    ./oci_database_data_guard_associations.dhall
, oci_database_db_home = ./oci_database_db_home.dhall
, oci_database_db_home_patches = ./oci_database_db_home_patches.dhall
...
, oci_database_db_system_patch_history_entries =
    ./oci_database_db_system_patch_history_entries.dhall
...
, oci_database_management_managed_databases_database_parameter =
    ./oci_database_management_managed_databases_database_parameter.dhall
, oci_database_management_managed_databases_database_parameters =
    ./oci_database_management_managed_databases_database_parameters.dhall
...
, oci_email_suppressions = ./oci_email_suppressions.dhall
, oci_events_rule = ./oci_events_rule.dhall
, oci_events_rules = ./oci_events_rules.dhall
, oci_file_storage_exports = ./oci_file_storage_exports.dhall
, oci_file_storage_export_sets = ./oci_file_storage_export_sets.dhall
, oci_file_storage_file_systems = ./oci_file_storage_file_systems.dhall
...
, oci_generic_artifacts_content_generic_artifacts_content =
    ./oci_generic_artifacts_content_generic_artifacts_content.dhall
...
, oci_health_checks_http_probe_results =
    ./oci_health_checks_http_probe_results.dhall
, oci_health_checks_ping_monitor = ./oci_health_checks_ping_monitor.dhall
, oci_health_checks_ping_monitors = ./oci_health_checks_ping_monitors.dhall
, oci_health_checks_ping_probe_results =
    ./oci_health_checks_ping_probe_results.dhall
, oci_health_checks_vantage_points = ./oci_health_checks_vantage_points.dhall
, oci_identity_api_keys = ./oci_identity_api_keys.dhall
, oci_identity_authentication_policy =
    ./oci_identity_authentication_policy.dhall
, oci_identity_auth_tokens = ./oci_identity_auth_tokens.dhall
, oci_identity_availability_domain = ./oci_identity_availability_domain.dhall
, oci_identity_availability_domains = ./oci_identity_availability_domains.dhall
, oci_identity_compartment = ./oci_identity_compartment.dhall
, oci_identity_compartments = ./oci_identity_compartments.dhall
, oci_identity_cost_tracking_tags = ./oci_identity_cost_tracking_tags.dhall
, oci_identity_customer_secret_keys = ./oci_identity_customer_secret_keys.dhall
, oci_identity_dynamic_groups = ./oci_identity_dynamic_groups.dhall
, oci_identity_fault_domains = ./oci_identity_fault_domains.dhall
, oci_identity_group = ./oci_identity_group.dhall
, oci_identity_groups = ./oci_identity_groups.dhall
...
, oci_identity_smtp_credentials = ./oci_identity_smtp_credentials.dhall
...
, oci_limits_resource_availability = ./oci_limits_resource_availability.dhall
, oci_limits_services = ./oci_limits_services.dhall
...
, oci_load_balancer_backend_set_health =
    ./oci_load_balancer_backend_set_health.dhall
, oci_load_balancer_backend_sets = ./oci_load_balancer_backend_sets.dhall
, oci_load_balancer_backendsets = ./oci_load_balancer_backendsets.dhall
...
, oci_load_balancer_protocols = ./oci_load_balancer_protocols.dhall
...
, oci_monitoring_alarms = ./oci_monitoring_alarms.dhall
...
, oci_objectstorage_namespace = ./oci_objectstorage_namespace.dhall
...
, oci_objectstorage_object_head = ./oci_objectstorage_object_head.dhall
...
, oci_waas_certificates = ./oci_waas_certificates.dhall
